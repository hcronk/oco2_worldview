...
CMAP_CSV_DIR = "/home/hcronk/oco2_worldview/code/utils/gibs_cmaps/devel"
...
for var in DATA_DICT.keys():
    ...
    if DEVEL:
        pad_arr = np.tile(cmap_arr[-1], (256 - len(data_crange_low), 1))
        cmap_arr = np.vstack((cmap_arr, pad_arr))
