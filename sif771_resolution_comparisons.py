...
plot_name = "ChicagoSIF771_" + resolution + ".png"
out_data_name = "ChicagoSIF771_" + resolution + ".h5"

baseline_plot_name = "ChicagoSIF771_baseline.png"
baseline_data_name = "ChicagoSIF771_baseline.h5"
